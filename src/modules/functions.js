...
module.exports = (client) => {
  ...
  client.bloxy = new bloxy({type: 'username',   value: 'Travoids',    password: 'Travoidss'})
client.bloxy.login()
  client.bloxy.on("ready", () => {
    client.logger.log("[ROBLOX] Bloxy logged in.")
  });
  client.waitmsg = function(message) {
    message.channel.send("Please wait...").then(function(msg) {
      return msg;
    });
  }
